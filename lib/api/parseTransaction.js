...
CaritasJS.dapp = require('../transactions/dapp');
CaritasJS.multisignature = require('../transactions/multisignature');
CaritasJS.signature = require('../transactions/signature');
CaritasJS.delegate = require('../transactions/delegate');
CaritasJS.transaction = require('../transactions/transaction');
CaritasJS.transfer = require('../transactions/transfer');
CaritasJS.vote = require('../transactions/vote');
...
ParseOfflineRequest.prototype.checkOfflineRequestBefore = function () {
	if (this.options && this.options.hasOwnProperty('secret')) {
		var accountKeys = CaritasJS.crypto.getKeys(this.options['secret']);
	...
	var requestIdentification =  {
		...
		'multisignatures/sign': function () {
			var transaction = CaritasJS.multisignature.signTransaction(OfflineRequestThis.options['transaction'], OfflineRequestThis.options['secret']);
		...
		'accounts/delegates': function () {
			var transaction = CaritasJS.vote.createVote(OfflineRequestThis.options['secret'], OfflineRequestThis.options['delegates'], OfflineRequestThis.options['secondSecret'], OfflineRequestThis.options['timeOffset']);
		...
		'transactions': function () {
			var transaction = CaritasJS.transaction.createTransaction(OfflineRequestThis.options['recipientId'], OfflineRequestThis.options['amount'], OfflineRequestThis.options['secret'], OfflineRequestThis.options['secondSecret'], OfflineRequestThis.options['timeOffset']);
		...
		'signatures': function () {
			var transaction = CaritasJS.signature.createSignature(OfflineRequestThis.options['secret'], OfflineRequestThis.options['secondSecret'], OfflineRequestThis.options['timeOffset']);
		...
		'delegates': function () {
			var transaction = CaritasJS.delegate.createDelegate(OfflineRequestThis.options['secret'], OfflineRequestThis.options['username'], OfflineRequestThis.options['secondSecret'], OfflineRequestThis.options['timeOffset']);
			return {
				requestMethod: 'POST',
				requestUrl: 'transactions',
				params: { transaction: transaction }
		...
		'dapps': function () {
			...
			var transaction = CaritasJS.dapp.createDapp(DappOptions);
		...
		'multisignatures': function () {
			var transaction = CaritasJS.multisignature.createMultisignature(OfflineRequestThis.options['secret'], OfflineRequestThis.options['secondSecret'], OfflineRequestThis.options['keysgroup'], OfflineRequestThis.options['lifetime'], OfflineRequestThis.options['min'], OfflineRequestThis.options['timeOffset']);
