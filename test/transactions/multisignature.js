...
describe('multisignature.js', function () {
	...
	var multisignature = caritas.multisignature;
	...
	describe('#signTransaction', function () {
		...
		var secret = '123';
		var transaction = caritas.transaction.createTransaction('58191285901858109L', 1000, 'secret');
	...
	describe('#createTransaction', function () {
		...
		var msigTransaction = caritas.multisignature.createTransaction(recipientId, amount, secret, secondSecret, requesterPublicKey);
		...
		it('should create a multisignature transaction without requesterPublicKey and secondSecret', function () {
			...
			var msigTransaction2 = caritas.multisignature.createTransaction(recipientId, amount, secret);
			var pubKey = caritas.crypto.getPrivateAndPublicKeyFromSecret(secret).publicKey;
